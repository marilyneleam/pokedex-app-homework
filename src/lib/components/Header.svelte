<header class="h-screen bg-white relative flex overflow-hidden">
    <nav
        class="h-full w-16 flex flex-col space-y-10 items-center justify-center relative bg-gray-800 text-white"
    >
        <a href="/">
            <div
                class="h-10 w-10 flex items-center justify-center rounded-lg cursor-pointer hover:text-gray-800 hover:bg-white hover:duration-300 hover:ease-linear focus:bg-white group"
            >
                <svg
                    class="h-6 w-6 group-hover:fill-gray-800"
